...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-[var(--color-surface)] p-6 shadow-[var(--shadow-elev-2)] transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
